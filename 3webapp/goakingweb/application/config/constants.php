...
define("dbuser", "root");
define("dbpassword", "");
define("dbname", "goakingweb");
}
else{
define("dbuser", "u346521377_goakinglive");
define("dbpassword", "Azmal@@123[];");
define("dbname", "u346521377_goakinglive");
}
...
//------basic change
define("website_name", 'GOA KING');
define("captcha_validation", false);
define("game_win_amount", 95); // ₹1 = ₹95
define("game_haruf", 9.5); // 1 ka 9.5 (100 का 950 ) 
