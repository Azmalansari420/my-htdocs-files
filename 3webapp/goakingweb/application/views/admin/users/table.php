    ...
    <tr>
      ...
      <td>
         <a href="<?=base_url($upload_path.$data->profile_image) ?>" target="_blank">
            <img src="<?=base_url($upload_path.$data->profile_image) ?>" style="width: 25%;">
         </a>
      </td>
      <td><?=$data->name ?></td>
      <td><?=$data->email ?></td>
      ...
      <td class="btn-col text-nowrap" width="1%">
        ...
        <a href="<?php echo base_url('admin_con/users/view_history?user_id='.$data->id); ?>" class="btn btn-info btn-xs m-r-2">Play</a>
