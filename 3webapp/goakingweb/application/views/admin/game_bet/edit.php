                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        <div class="col-12 grid">
                           ...
                           ?>
                               <div class="grid-item">
                                   ...
                                   <input 
                                       ...
                                       class="bet-input" disabled style="background-color: <?php echo ($bet_amount ? 'blue' : 'green'); ?>;">
                               </div>
                           <?php endfor; ?>
                         ...
                         <div class="grid-item">
                             <span class="number"><?php echo $formatted_number; ?></span>
                             <input  type="text"  name="<?php echo $formatted_number; ?>" value="<?php echo $bet_amount; ?>"  class="bet-input" disabled style="background-color: <?php echo ($bet_amount ? 'blue' : 'green'); ?>;">
                         </div>
                     ...
                     <div class="row card-body">
                        ...
                        <div class="col-12 grid">
                           ...
                           <div class="grid-item">
                              ...
                              <input type="text" name="A1"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A1)) echo $bet_amount_A1; ?>" style="background-color: <?php echo ($bet_amount_A1 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A2</span>
                              <input type="text" name="A2"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A2)) echo $bet_amount_A2; ?>" style="background-color: <?php echo ($bet_amount_A2 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A3</span>
                              <input type="text" name="A3"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A3)) echo $bet_amount_A3; ?>" style="background-color: <?php echo ($bet_amount_A3 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A4</span>
                              <input type="text" name="A4"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A4)) echo $bet_amount_A4; ?>" style="background-color: <?php echo ($bet_amount_A4 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A5</span>
                              <input type="text" name="A5"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A5)) echo $bet_amount_A5; ?>" style="background-color: <?php echo ($bet_amount_A5 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A6</span>
                              <input type="text" name="A6"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A6)) echo $bet_amount_A6; ?>" style="background-color: <?php echo ($bet_amount_A6 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A7</span>
                              <input type="text" name="A7"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A7)) echo $bet_amount_A7; ?>" style="background-color: <?php echo ($bet_amount_A7 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A8</span>
                              <input type="text" name="A8"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A8)) echo $bet_amount_A8; ?>" style="background-color: <?php echo ($bet_amount_A8 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A9</span>
                              <input type="text" name="A9"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A9)) echo $bet_amount_A9; ?>" style="background-color: <?php echo ($bet_amount_A9 ? 'blue' : 'green'); ?>;">
                           </div>
                           <div class="grid-item">
                              <span class="number">A0</span>
                              <input type="text" name="A0"  class="bet-input" disabled value="<?php if(!empty($bet_amount_A0)) echo $bet_amount_A0; ?>" style="background-color: <?php echo ($bet_amount_A0 ? 'blue' : 'green'); ?>;">
                           </div>
                        </div>
                        ...
                        <div class="col-12 grid mt-2">
                          ...
                          <div class="grid-item">
                            ...
                            <input type="text" name="B1"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B1)) echo $bet_amount_B1; ?>" style="background-color: <?php echo ($bet_amount_B1 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B2</span>
                            <input type="text" name="B2"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B2)) echo $bet_amount_B2; ?>" style="background-color: <?php echo ($bet_amount_B2 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B3</span>
                            <input type="text" name="B3"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B3)) echo $bet_amount_B3; ?>" style="background-color: <?php echo ($bet_amount_B3 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B4</span>
                            <input type="text" name="B4"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B4)) echo $bet_amount_B4; ?>" style="background-color: <?php echo ($bet_amount_B4 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B5</span>
                            <input type="text" name="B5"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B5)) echo $bet_amount_B5; ?>" style="background-color: <?php echo ($bet_amount_B5 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B6</span>
                            <input type="text" name="B6"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B6)) echo $bet_amount_B6; ?>" style="background-color: <?php echo ($bet_amount_B6 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B7</span>
                            <input type="text" name="B7"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B7)) echo $bet_amount_B7; ?>" style="background-color: <?php echo ($bet_amount_B7 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B8</span>
                            <input type="text" name="B8"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B8)) echo $bet_amount_B8; ?>" style="background-color: <?php echo ($bet_amount_B8 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B9</span>
                            <input type="text" name="B9"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B9)) echo $bet_amount_B9; ?>" style="background-color: <?php echo ($bet_amount_B9 ? 'blue' : 'green'); ?>;">
                          </div>
                          <div class="grid-item">
                            <span class="number">B0</span>
                            <input type="text" name="B0"  class="bet-input" disabled value="<?php if(!empty($bet_amount_B0)) echo $bet_amount_B0; ?>" style="background-color: <?php echo ($bet_amount_B0 ? 'blue' : 'green'); ?>;">
                          </div>
                        </div>
