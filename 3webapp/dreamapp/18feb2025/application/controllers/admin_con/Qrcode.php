...
class Qrcode extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Qrcode',
						   	'table_name'=>'qrcode',
						   	'upload_path'=>'media/uploads/qrcode/',
						   	'load_path'=>'admin/qrcode/',
						   	'redirect_path'=>'admin_con/qrcode/',
						   	'back_url'=>'qrcode',
						   	'add_url'=>'qrcode',
						   	'edit_url'=>'qrcode',
						   	'delete_url'=>'qrcode',
						   	'view_url'=>'qrcode',
						   	'table_url'=>'admin/qrcode/table',
						   	'status_value'=>'qrcode',
						   	'multiple_delete'=>'admin_con/qrcode/delete_all',
						   	'pagination_url'=>'admin_con/qrcode/get_table_data',
						   	'controller_name'=>'qrcode',
						   	'page_name'=>'qrcode.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		check_controller_inner_access(4,2);
