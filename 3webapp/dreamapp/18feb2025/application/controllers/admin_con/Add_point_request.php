...
class Add_point_request extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Add Point Request',
						   	'table_name'=>'add_point_request',
						   	'upload_path'=>'media/uploads/add_point_request/',
						   	'load_path'=>'admin/add_point_request/',
						   	'redirect_path'=>'admin_con/add_point_request/',
						   	'back_url'=>'add_point_request',
						   	'add_url'=>'add_point_request',
						   	'edit_url'=>'add_point_request',
						   	'delete_url'=>'add_point_request',
						   	'view_url'=>'add_point_request',
						   	'table_url'=>'admin/add_point_request/table',
						   	'status_value'=>'add_point_request',
						   	'multiple_delete'=>'admin_con/add_point_request/delete_all',
						   	'pagination_url'=>'admin_con/add_point_request/get_table_data',
						   	'controller_name'=>'add_point_request',
						   	'page_name'=>'add_point_request.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		check_controller_inner_access(5,2);
	...
	function listing()
	{		
		check_controller_inner_access(5,1);
		$data['page_title'] = $this->arr_values['page_title'];
	...
	public function delete()
	  {
	  	check_controller_inner_access(5,4);
	...
	function edit()
	{
		check_controller_inner_access(5,3);		 
		$args=func_get_args();
		if(isset($_POST['submit']))
		{
			date_default_timezone_set('Asia/Kolkata');
	...
	function view()
	{
		check_controller_inner_access(5,5);		 
		$args=func_get_args();
		$data['page_title'] = $this->arr_values['page_title'];
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['back_url'] = base_url('admin_con/'.$this->arr_values['back_url'].'/listing');
