...
.add-more-btn {
    ...
    <div class="single-page-area">
        <div class="title-area justify-content-between">
            ...
            <h3 class="ps-4 text-white"><?=lang("Wallet") ?></h3>
                    ...
                    <div class="widget-body">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="justify-content: space-between;">
                          <li class="nav-item" role="presentation" style="width: 48%;">
                            <button class="nav-link w-100 active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true" style="background-color: green;"><?=lang("Add Point") ?></button>
                          </li>
                          <li class="nav-item" role="presentation" style="width: 48%;">
                            <button class="nav-link w-100" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false" style="background-color: orangered;"><?=lang("Withdraw") ?></button>
                          </li>
                        </ul>
                            ...
                            <div class="my-profile-detail box-xolor">
                                <form class="edit-form-wrap">
                                    ...
                                    <div class="single-input-wrap">
                                        ...
                                        <input type="text" class="form-control amount" placeholder="<?=lang("Enter Your Amount") ?>" id="w_amount" required>
                                    </div>

                                    <div class="text-center">
                                        <?php  
                                        $buttons = explode(",", "500,1000,1500,2000,2500,3000,3500");
                                    ...
                                    <a class="btn btn-base w-100 mt-2 submit-btn" href="javascript:void(0);"><?=lang("Continue") ?></a>
                                </form>
                            </div>

                            <!-- wallet History -->
                            <div class="my-profile-detail box-xolor mt-0  mb-0">
                              <h6 class="title pt-3"><?=lang("Wallet History") ?></h6>
                              <div class="scrollable-table">
                                ...
                                <div style="text-align: center;margin-top: 8px;margin-bottom: 5px;">
                                    <a href="javascript:void(0);" class="add-point-load-more-btn add-more-btn"><?=lang("Load More") ?></a>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <div class="my-profile-detail box-xolor">
                                <form class="edit-form-wrap">
                                    <div class="single-input-wrap">
                                        <label><?=lang("Amount") ?></label>
                                        <input type="text" class="form-control w-amount" placeholder="<?=lang("Enter Your Amount") ?>" id="w_amount2" required>
                                    </div>
                                    ...
                                    <div class="single-input-wrap" style="display:none;">
                                        <label><?=lang("UPI NO") ?></label>
                                        <input type="text" class="form-control upi_no" placeholder="<?=lang("Enter Your UPI NO") ?>"  required>
                                    </div> 

                                    <div class="single-input-wrap" style="display:none;">
                                        <label><?=lang("Bank Name") ?></label>
                                        <input type="text" class="form-control bank_name" placeholder="<?=lang("Enter Your Bank Name") ?>"  required>
                                    </div> 

                                    <div class="single-input-wrap" style="display:none;">
                                        <label><?=lang("Account Holder Name") ?></label>
                                        <input type="text" class="form-control ac_name" placeholder="<?=lang("Enter Your Account Holder Name") ?>"  required>
                                    </div>                                   
                                    
                                    <div class="single-input-wrap" style="display:none;">
                                        <label><?=lang("Account Number") ?></label>
                                        <input type="text" class="form-control ac_no" placeholder="<?=lang("Enter Your Account Number") ?>"  required>
                                    </div> 
                                    <div class="single-input-wrap" style="display:none;">
                                        <label><?=lang("Confirm Account Number") ?></label>
                                        <input type="text" class="form-control con_ac_no" placeholder="<?=lang("Enter Your Confirm Account Number") ?>"  required>
                                    </div>  
                                    <div class="single-input-wrap" style="display:none;">
                                        <label><?=lang("IFSC Code") ?></label>
                                        <input type="text" class="form-control ifsc_code" placeholder="<?=lang("Enter Your IFSC Code") ?>"  required>
                                    </div>                                   
                                    
                                    <a class="btn btn-base w-100 mt-2 withdraw-submit-btn" href="javascript:void(0);"><?=lang("Withdraw") ?></a>
                                </form>
                            </div>

                            <div class="my-profile-detail box-xolor mt-0  mb-0">
                              <h6 class="title pt-3"><?=lang("Withdraw History") ?></h6>
                              <div class="scrollable-table">
                                <table>
                                  <thead>
                                    <tr>
                                ...
                                <div style="text-align: center;margin-top: 8px;margin-bottom: 5px;">
                                    <a href="javascript:void(0);" class="withdraw-load-more-btn add-more-btn"><?=lang("Load More") ?></a>
                                </div>
                              </div>
                            </div>
                          </div>
...
/*addd point request*/
  $(document).on("click", ".submit-btn",(function(e) {
    ...
    function add_point()
    {
        ...
        var user_id = "DA<?=$full_detail->user_id ?>";
        var user_mobile = "<?=$full_detail->mobile ?>";
        var username = "<?=$full_detail->name ?>";

        if (isNaN(amount) || amount < 5) {
            toaster("Minimum bet amount is 5. (e.g., 5, 10, 15...)", 'error');
            isValid = false;
            return false;
        }
        ...
        $.ajax(settings).done(function (response) {
          ...
          if(response.status==200)
          {
            ...
            var whatsapp_url = "https://api.whatsapp.com/send?phone=91<?=$site_setting[0]->mobile ?>&text=" +
                encodeURIComponent(
                "Add Point Request" + "\n" +
                "Amount: " + amount + "\n" +
                "User ID: " + user_id + "\n" +
...
/*add pointy list*/
    ...
    function withdraw_request()
    {
        ...
        if(amount<=499)
        {
            toaster("Minimum Amount 500.", 'error');
            return false;
        }
        // if(upi_no=='')
        // {
