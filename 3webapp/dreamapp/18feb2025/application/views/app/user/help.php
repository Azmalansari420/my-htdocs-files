...
<body class='sc5'>
    ...
    <div class="single-page-area">
        <div class="title-area justify-content-between">
            ...
            <h3 class="ps-4 text-white"><?=lang("Help Center") ?></h3>
        ...
        <div class="container">
            ...
            <div class="mt-3 d-flex justify-content-around">
                <a class="video-btn" href="<?=$sitesetting[0]->deposite ?>"><?=lang("Deposite") ?></a>
                <a class="video-btn" href="<?=$sitesetting[0]->withdraw ?>"><?=lang("Withdraw") ?></a>
                <a class="video-btn" href="<?=$sitesetting[0]->game_play ?>"><?=lang("Game Play") ?></a>
            </div>
