               ...
               <div class="card ">
                  <div class="card-header card-header-inverse">
                     ...
                     <div class="card-header-btn">
                        <!-- <a href="<?php echo $add_url; ?>" class="btn btn-blue">Add <?=$page_title ?></a> -->
                        <a href="<?= base_url('admin_con/users/export_to_excel') ?>" class="btn btn-success">Export to Excel</a>
...
<script>
    ...
    rows.forEach(row => {
        ...
        cols.forEach(col => {
            rowData.push('"' + col.innerText.replace(/"/g, '""') + '"'); // Handle quotes
        });
