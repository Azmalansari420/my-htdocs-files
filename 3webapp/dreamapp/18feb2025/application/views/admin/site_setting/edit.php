               ...
               <div class="col-lg-8">
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-6 form-group">
                           <label>Deposite Youtube Link</label>
                           <input type="text" class="form-control"  name="deposite" value="<?php echo $EDITDATA[0]->deposite; ?>">
                        </div>
                        <div class="col-6 form-group">
                           <label>Withdraw Youtube Link</label>
                           <input type="text" class="form-control"  name="withdraw" value="<?php echo $EDITDATA[0]->withdraw; ?>">
                        </div>
                        <div class="col-6 form-group">
                           <label>Game Play Youtube Link</label>
                           <input type="text" class="form-control"  name="game_play" value="<?php echo $EDITDATA[0]->game_play; ?>">
                        </div>
