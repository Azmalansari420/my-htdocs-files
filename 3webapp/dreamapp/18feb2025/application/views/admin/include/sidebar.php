...
<sidebar id="sidebar" class="app-sidebar">
   <div data-scrollbar="true" data-height="100%">
      <ul class="nav">
         ...
         <li class="<?php if($currentURL==base_url('admin_con/win_amount/edit/1')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/win_amount/edit/1'); ?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Set Amount</span>
            </a>
         </li>
      ...
      <!--    <li class="<?php if($currentURL==base_url('admin_con/referal_user/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/referal_user/listing');?>">
               <span class="nav-icon"><i class="fa fa-user-check bg-black text-white"></i></span>
               <span class="nav-text">Referal Users</span>
            </a>
         </li>
 -->
         ...
         <li class="has-sub">
            ...
            <ul class="nav-submenu">
               ...
               <li class="active"><a href="<?php echo base_url('admin_con/content/edit/8'); ?>"><span class="nav-text">Game Rate</span></a></li>
