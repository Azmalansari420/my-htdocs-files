<table class="table table-striped table-td-valign-middle table-bordered bg-white">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?=$data->jodi_rate ?></td>
      <td><?=$data->haruf_rate ?></td>
      <td><?=date('h:i A',strtotime($data->open_time)) ?></td>
      <td><?=date('h:i A',strtotime($data->close_time)) ?></td>
      <td><?=date('h:i A',strtotime($data->result_time)) ?></td>
      <td>
