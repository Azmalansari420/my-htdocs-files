...
define("dbuser", "root");
define("dbpassword", "");
define("dbname", "dreamapp");
}
else{
define("dbuser", "dreamapp_webapp");
define("dbpassword", "Admin@123");
define("dbname", "dreamapp_webapp");
}
...
//------basic change
define("website_name", 'Dream App');
define("captcha_validation", false);
define("game_jodi", 100); // ₹1 = ₹100
define("game_haruf", 10); // 1 ka ₹10 
...
define("smskey", "1zIcZCkfcKvOOMOL9JNIWY9WwC1gDznb7KNvbxIbNkRy5KKWQUVGR4KA85Q0");