...
<head>
	...
	<meta property="og:image" content="https://footflare.dexignzone.com/mobile/social-image.png">
	<meta name="format-detection" content="telephone=no">
	<meta name="twitter:title" content="<?=website_name ?>">
	<meta name="twitter:description" content="<?=website_name ?>">
	<meta name="twitter:image" content="<?=website_name ?>">
	<meta name="twitter:card" content="summary_large_image">
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, minimal-ui, viewport-fit=cover">
	<link rel="shortcut icon" type="image/x-icon" href="<?=base_url() ?>assets/images/app-logo/favicon.png">
