         ...
         <div id="content" class="app-content">
            ...
            <div class="row">
               ...
               <div class="col-xl-3 col-sm-6">
                  <a href="<?php echo base_url('admin_con/finalorder/listing');?>" class="widget-stats bg-gradient-blue text-white m-b-15">
                     <div class="widget-stats-info">
                        <div class="widget-stats-title">Today Orders</div>
                        <div class="widget-stats-value">
                           <?php
                           $today = date('Y-m-d');
                           $count = $this->db->get_where('finalorder',array('order_status'=>1,'orderdate'=>$today))->result_object();
                           $totcount = count($count);
                           print_r($totcount);
                           ?>
                        </div>
                        <!-- <div class="widget-stats-desc"><?=date('Y-m-d'); ?></div> -->
                     </div>
               ...
               <div class="col-xl-3 col-sm-6">
                  <a href="<?php echo base_url('admin_con/unreadorder/listing');?>" class="widget-stats widget-stats-inverse bg-gradient-purple m-b-15">
                     <div class="widget-stats-info">
                        <div class="widget-stats-title">Un-Read Orders</div>
                        <div class="widget-stats-value">
                           <?php
                           $today = date('Y-m-d');
                           $count = $this->db->get_where('finalorder',array('order_status'=>1,))->result_object();
                           $totcount = count($count);
                           print_r($totcount);
                           ?>
                        </div>
               ...
               <div class="col-xl-3 col-sm-6">
                  <a href="<?php echo base_url('admin_con/product/listing');?>" class="widget-stats widget-stats-inverse bg-gradient-orange m-b-15">
                     <div class="widget-stats-info">
                        <div class="widget-stats-title">Total Product</div>
                        <div class="widget-stats-value">
                           <?php
                           $count = $this->db->get_where('product')->result_object();
                           $totcount = count($count);
                           print_r($totcount);
                           ?>
                        </div>
