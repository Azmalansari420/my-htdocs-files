<table class="table table-striped table-td-valign-middle table-bordered bg-white">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
         <a href="<?=base_url($upload_path.$data->icon) ?>" target="_blank">
            <img src="<?=base_url($upload_path.$data->icon) ?>" width="100">
         </a>
      </td>
      <td>
         <a href="<?=base_url($upload_path.$data->image) ?>" target="_blank">
            <img src="<?=base_url($upload_path.$data->image) ?>" width="100">
         </a>
      </td>
      <td><?=$data->name ?></td>
      <td><?=show_home($data->show_home) ?></td>
      <td>
