...
class Pricerange extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Price Range',
						   	'table_name'=>'pricerange',
						   	'upload_path'=>'media/uploads/pricerange/',
						   	'load_path'=>'admin/pricerange/',
						   	'redirect_path'=>'admin_con/pricerange/',
						   	'back_url'=>'pricerange',
						   	'add_url'=>'pricerange',
						   	'edit_url'=>'pricerange',
						   	'delete_url'=>'pricerange',
						   	'view_url'=>'pricerange',
						   	'table_url'=>'admin/pricerange/table',
						   	'status_value'=>'pricerange',
						   	'multiple_delete'=>'admin_con/pricerange/delete_all',
						   	'pagination_url'=>'admin_con/pricerange/get_table_data',
						   	'controller_name'=>'pricerange',
						   	'page_name'=>'pricerange.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	public function get_table_data() 
	{
	  ...
	  $this->db->like('start', $search);
	  $this->db->or_like('finish', $search);
