...
class Unreadorder extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Unread Orders',
						   	'table_name'=>'finalorder',
						   	'upload_path'=>'media/uploads/unreadorder/',
						   	'load_path'=>'admin/unreadorder/',
						   	'redirect_path'=>'admin_con/unreadorder/',
						   	'back_url'=>'unreadorder',
						   	'add_url'=>'unreadorder',
						   	'edit_url'=>'unreadorder',
						   	'delete_url'=>'unreadorder',
						   	'view_url'=>'unreadorder',
						   	'table_url'=>'admin/unreadorder/table',
						   	'status_value'=>'unreadorder',
						   	'multiple_delete'=>'admin_con/unreadorder/delete_all',
						   	'pagination_url'=>'admin_con/unreadorder/get_table_data',
						   	'controller_name'=>'unreadorder',
						   	'invoice_url'=>'unreadorder',
						   	'page_name'=>'unreadorder.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	function listing()
	{		
		check_controller_inner_access(14,1);
	...
	public function delete()
	  {
	  	check_controller_inner_access(14,4);
	...
	function edit()
	{
		check_controller_inner_access(14,3);		 
		$args=func_get_args();
	...
	function view()
	{
		check_controller_inner_access(14,5);		 
		$args=func_get_args();
		$data['page_title'] = $this->arr_values['page_title'];
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['back_url'] = base_url('admin_con/'.$this->arr_values['back_url'].'/listing');
