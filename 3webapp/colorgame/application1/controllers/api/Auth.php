...
class Auth extends CI_Controller {
    ...
    /* signup by otp start */
        ...
        //     if(strlen($phone)!=10)
        //     {
        //         $result['message'] = "Mobile No. Only 10 Digit";
        //         $result['status']  = "400";
        //         $result['data']    = [];
        //         echo json_encode($result);
        //         die;
        ...
        //     {
        //         $check_referral = $this->db->get_where("users",array('id'=>$referral_id,"is_delete"=>0,))->result_array();
    ...
    public function logout()
    {
        ...
        if(!empty($u))
        {
            ...
            redirect(base_url(user_app.'login?id='.$this->session->userdata("device_id").'&firebase_token='.$this->session->userdata("firebase_token")));
        }
        else
        {
            redirect(base_url(user_app.'login?id='.$this->session->userdata("device_id").'&firebase_token='.$this->session->userdata("firebase_token")));
