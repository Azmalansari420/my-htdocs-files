			...
			<div class="container">
				<div class="header-content">
					<div class="left-content">
						...
						<h6 class="title font-14">Notification</h6>
					</div>
	...
	<div class="page-content space-top p-b50">
			...
			<div class="dz-notification">
				<ul class="notification-list">
					...
					<li class="list-items fill-color">
						...
						<span class="time"><i class="icon feather icon-clock"></i> <?=gettimediffrence($data->addeddate) ?> ago</span>
					</li>
				<?php } ?>
		...
		<?php } ?>
			...
			<div class="title-bar mb-0">
				 <h6 class="title mb-0">All Notification</h6>
			</div>
...
<script>
    ...
    function load_more()
    {
        ...
        var settings = {
          "url": "<?=base_url() ?>api/Image_filter/notificationlist",
          "method": "POST",
          "dataType": "json",
          "timeout": 0,
          "processData": false,
