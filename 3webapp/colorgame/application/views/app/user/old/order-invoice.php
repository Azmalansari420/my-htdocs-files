         ...
         <div class="bill_total_wrap">
            <div class="bill_sec">
               <p class="bold name">SHIPPING ADDRESS</p> 
                  <p><?php echo $EDITDATA[0]->name; ?></p>
                 <span>
                   <?php echo $EDITDATA[0]->mobile; ?><br>
                   <?php echo $EDITDATA[0]->email; ?><br>
                   <?php echo $EDITDATA[0]->address; ?> <?php echo statename($EDITDATA[0]->state); ?>  <?php echo cityname($EDITDATA[0]->city); ?>   <br><?php echo $EDITDATA[0]->pincode; ?> <br>
                 </span>
            </div>
            ...
            <div class="table_body">
               ...
               <div class="row">                
                  <div class="col col_des">
                           <img src="<?php echo base_url(); ?>media/uploads/product/<?php echo $data->image; ?>" alt="full-image" style="height: 125px">
                  </div>
                  <div class="col col_price">
                     <p><?php echo $data->name; ?></p>
                     <strong>Color:- <?php echo colorname($data->color_id); ?></strong><br>
                     <strong>Size:- <?php echo sizename($data->size_id); ?></strong>
                  </div>
                  <div class="col col_price">
                     <p>₹ <?php echo number_format($data->sale_price,2); ?></p>
                  </div>
                  <div class="col col_qty">
                     <p><?php echo $data->quantity; ?></p>
                  </div>
                  <div class="col col_total">
                     <p>₹ <?php echo number_format($data->quantity*$data->sale_price,2); ?></p>
                  </div>
               </div>
            <?php } ?>
