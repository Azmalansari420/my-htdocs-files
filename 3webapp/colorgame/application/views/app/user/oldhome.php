				...
				<div class="swiper category-slide">
					<div class="swiper-wrapper" style="justify-content: center;">
						...
						<div class="swiper-slide1">	
							<a href="javascript:void(0);" class="category-btn custom-btns <?php if($key==0) echo 'game-active' ?>" data-game_id="<?=$data->id ?>"><?=$data->name ?></a>
						</div>
						<?php } ?>						
					</div>
				</div>
...
<?php include('include/footer.php'); ?>
 ...
 <script>
 	...
 	{
 		$(".category-btn").removeClass("game-active");
	    $(this).addClass("game-active");
	    const activeGameId = $(this).attr("data-game_id");
