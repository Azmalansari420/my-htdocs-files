                        ...
                        <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    <!-- <a href="<?php echo $view_url.$data->id; ?>" class="listicon"><i class="fa fa-eye"></i></a> -->
                                    <a href="<?php echo $edit_url.$data->id; ?>" class="mx-2 listicon" class="listicon"><i class="fa fa-edit"></i></a>
                                    <a href="<?php echo $delete_url.$data->id; ?>" class="listicon delete"><i class="fa fa-trash"></i></a>
                                 </td>
                              </tr>
                           <?php } ?>
