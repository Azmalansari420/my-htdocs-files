                           ...
                           <div class="row">
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->name; ?>" name="name" required>
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Price</label>
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->price; ?>" name="price">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Days</label>
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->days; ?>" name="days">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Field 1</label>
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->field_1; ?>" name="field_1">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Field 2</label>
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->field_2; ?>" name="field_2">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Field 3</label>
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->field_3; ?>" name="field_3">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Field 4</label>
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->field_4; ?>" name="field_4">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Field 5</label>
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->field_5; ?>" name="field_5">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Field 6</label>
                                    <input type="text" class="form-control" value="<?php echo $EDITDATA[0]->field_6; ?>" name="field_6">
                                 </div>
                              </div>
