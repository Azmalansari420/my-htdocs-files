                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="small_info"  placeholder="Enter text ..." rows="6"></textarea>
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Youtube Link</label>
                                    <textarea class="form-control" name="youtube"  placeholder="Enter text ..." rows="6"></textarea>
                                 </div>
                              </div>
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Content</label>
                                    <textarea class="form-control" name="content" id="wysihtml5"  placeholder="Enter text ..." rows="12"></textarea>
                                 </div>
                              </div>
                           </div>
                        </div>
