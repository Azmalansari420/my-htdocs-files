                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="small_info"  placeholder="Enter text ..." rows="6"><?php echo $EDITDATA[0]->small_info; ?></textarea>
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Youtube Link</label>
                                    <textarea class="form-control" name="youtube"  placeholder="Enter text ..." rows="6"><?php echo $EDITDATA[0]->youtube; ?></textarea>
                                 </div>
                              </div>
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
