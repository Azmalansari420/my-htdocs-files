...
class Plans extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Plans',
						   	'table_name'=>'plans',
						   	'upload_path'=>'media/uploads/plans/',
						   	'load_path'=>'admin/plans/',
						   	'redirect_path'=>'admin_con/plans/',
						   	'back_url'=>'plans',
						   	'add_url'=>'plans',
						   	'edit_url'=>'plans',
						   	'delete_url'=>'plans',
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$data['field_1'] = $this->input->post('field_1');			
			$data['field_2'] = $this->input->post('field_2');			
			$data['field_3'] = $this->input->post('field_3');			
			$data['field_4'] = $this->input->post('field_4');			
			$data['field_5'] = $this->input->post('field_5');			
			$data['field_6'] = $this->input->post('field_6');			
