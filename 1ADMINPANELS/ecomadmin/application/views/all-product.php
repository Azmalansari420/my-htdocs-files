                                                ...
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="<?php echo base_url('product-details/'.$data->slug); ?>">
                                                            <img class="product__items--img product__primary--img" src="<?php echo base_url(); ?>media/uploads/product/<?php echo $showimage; ?>" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="<?php echo base_url(); ?>media/uploads/product/<?php echo $data->thumb_img; ?>" alt="product-img">
                                                        </a>
                                                    </div>
                                                    <div class="product__items--content">
                                                        ...
                                                        <div class="product__items--price">
                                                            <span class="current__price">₹ <?php echo $data->original_price; ?></span>
                                                            <span class="price__divided"></span>
                                                            <span class="old__price">₹ <?php echo $data->cut_price; ?></span>
                                                        </div>
                                                        ...
                                                        <ul class="product__items--action d-flex">
                                                            <li class="product__items--action__list">
                                                                <a class="product__items--action__btn add__to--cart addtocart" data-p_id="<?=$data->id ?>">
