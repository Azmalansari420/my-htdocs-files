                            ...
                            <div class="col-lg-8">
                                <div class="cart__table">
                                    <table class="cart__table--inner">
                                        ...
                                        <tbody class="cart__table--body">
                                            ...
                                            foreach ($cartpro as $key => $value) 
                                            {
                                                ...
                                                // $allimage = $this->crud->selectDataByMultipleWhere('all_images',array('p_id'=>$value->p_id,));
                                            ...
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        <button onclick="deletecart(<?=$value->id ?>)" class="cart__remove--btn" aria-label="search button" type="button">
                                                        ...
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title">
                                                                <a href="<?php echo base_url('product-details/'.$product[0]->slug); ?>"><?php echo $product[0]->name; ?></a>
                                                            </h4>
                                                ...
                                                <td class="cart__table--body__list">
                                                 ...
                                                 <td class="cart__table--body__list">
                                                    <div class="quantity__box">
                                                            <input class="qty_set" name="quantity" data-id="<?php echo $value->id; ?>" type="number" value="<?php echo $value->quantity; ?>">
                                                    </div>
                                                </td>
                                                <!-- <td class="cart__table--body__list">
                                                    <div class="quantity__box">
                                                ...
                                                <td class="cart__table--body__list">
                                                    <span class="cart__price end">₹ <?php echo number_format($product_total,2); ?></span>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                   ...
                                   <!--  <div class="continue__shopping d-flex justify-content-between">
                                        <a class="continue__shopping--link" href="<?php echo base_url('shop'); ?>">Continue shopping</a>
                                        <a href="<?php echo base_url('cart/allcart_delete/'.$cartpro[0]->p_id); ?>" class="continue__shopping--clear" type="submit">Clear Cart</a>
                                    </div> -->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="cart__summary border-radius-10">
                                        ...
                                        <table class="cart__summary--total__table">
                                            <tbody>
                                                <tr class="cart__summary--total__list">
                                                    ...
                                                    <td class="cart__summary--amount text-right">₹ <?php echo number_format($sub_total,2); ?></td>
                                                </tr>
                                                <tr class="cart__summary--total__list">
                                                    <td class="cart__summary--total__title text-left">SHIPPING CHARGE</td>
                                                    <td class="cart__summary--amount text-right">₹ <?php echo number_format($shipping_charge,2); ?></td>
                                                </tr>
                                                <tr class="cart__summary--total__list">
                                    ...
                                    <div class="cart__summary--footer">
                                        ...
                                        <ul class="d-flex justify-content-between">
                                            <li><a class="cart__summary--footer__btn primary__btn checkout" href="<?php echo base_url('checkout'); ?>">Check Out</a></li>
                                        </ul>
                                    </div>
                                </div> 
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="<?php echo base_url('product-details/'.$product[0]->slug); ?>">
                                ...
                                <div class="product__items--content">
                                    ...
                                    <h3 class="product__items--content__title h4"><a href="<?php echo base_url('product-details/'.$product[0]->slug); ?>"><?php echo $product[0]->name; ?></a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">₹ <?php echo number_format($price); ?></span>
                                        <span class="price__divided"></span>
                                        <span class="old__price">₹ <?php echo number_format($cut_price); ?></span>
                                    </div>
