            ...
            <div class="container">
                ...
                <div class="main__contact--area position__relative">
                    ...
                    <div class="contact__form">
                        ...
                        <form class="contact__form--inner" action="<?php echo base_url('welcome/enquiry_form'); ?>" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" name="mobile" id="input3" placeholder="Phone number" type="text" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input2">Subject <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="subject" id="input2" placeholder="Subject" type="text">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-15">
                                        <label class="contact__form--label" for="input5">Write Your Message <span class="contact__form--label__star">*</span></label>
                                        <textarea class="contact__form--textarea" required name="message" id="input5" placeholder="Write Your Message"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">Change the design through a range <br> <a href="tel:<?php echo $sitesetting[0]->mobile; ?>"><?php echo $sitesetting[0]->mobile; ?></a> <a href="tel:+<?php echo $sitesetting[0]->alt_mobile; ?>"><?php echo $sitesetting[0]->alt_mobile; ?></a>   </p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"> <a href="mailto:<?php echo $sitesetting[0]->email; ?>"><?php echo $sitesetting[0]->email; ?></a> <br> <a href="mailto:<?php echo $sitesetting[0]->alt_email; ?>"><?php echo $sitesetting[0]->alt_email; ?></a></p> 
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">  <?php echo $sitesetting[0]->address; ?></p> 
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <ul class="contact__info--social d-flex">
                                <li class="contact__info--social__list">
                                    <a class="contact__info--social__icon" target="_blank" href="<?php echo $sitesetting[0]->facebook; ?>">
                                ...
                                <li class="contact__info--social__list">
                                    <a class="contact__info--social__icon" target="_blank" href="<?php echo $sitesetting[0]->twitter; ?>">
                                ...
                                <li class="contact__info--social__list">
                                    <a class="contact__info--social__icon" target="_blank" href="<?php echo $sitesetting[0]->instagram; ?>">
                                ...
                                <li class="contact__info--social__list">
                                    <a class="contact__info--social__icon" target="_blank" href="<?php echo $sitesetting[0]->youtube; ?>">
