                        ...
                        <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                           <thead>
                              <tr>
                                 ...
                                 <th class="text-nowrap">Small Info</th>
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    <img src="<?php echo base_url($upload_path); ?><?php echo $data->banner; ?>" class="rounded h-60px my-n1 mx-n1" width="75"/>
                                 </td>
                                 <td class=""><?php echo $data->name; ?></td>
                                 <td class=""><?php echo $data->small_info; ?></td>
